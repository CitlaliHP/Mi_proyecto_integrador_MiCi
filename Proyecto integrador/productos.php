...
<body>
    ...
    <script>
        ...
        function sendTelegramMessage(orden)
        {
            ...
            var mensaje = 'Alumno: ' + orden.matricula + '. Preparar: ' + orden.productos + '. --> ' + orden.precioTotal; 
        ...
        function cobrar()
    {
        ...
        if(parseInt(document.getElementById("id_precio_total").innerHTML.replace('$', '')) == 0)
        {
            ...
            {
                sendTelegramMessage(orden);
                alert('Se le notificara a la cafetería, en breve puede pasar por su pedido, ¡Hasta luego!');
                window.location.href = 'inicio_sesion.html';
            }
        }  
    }
